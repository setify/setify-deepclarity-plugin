# Deep Clarity Strukturanalyse – KI-Skill

## ⚠️ KRITISCH: ZWECK DIESES SKILLS
...
1. Du erstellst: STRUKTURANALYSE (Fachsprache)
   ↓
2. Anderer AI Agent nutzt: STRUKTURANALYSE als INPUT
   ↓
3. Anderer AI Agent erstellt: DOSSIER (Business-Sprache)
```
...
- KEIN JSON!
- Für Menschen lesbar
- Fachsprachlich (nicht für Klienten!)
...
- ❌ KEINE Business-Übersetzung (das macht das Dossier!)

---

## Zweck dieses Dokuments

Dieses Dokument befähigt dich, aus Transkripten von Gesprächen, diagnostischen Notizen und Beobachtungen eine vollständige Strukturanalyse nach der Deep Clarity Methode durchzuführen. Du analysierst die innere Verarbeitungsorganisation eines Menschen – nicht Inhalte, sondern Muster.
...
Eine Strukturanalyse erfasst, **wie** ein Mensch innere und äußere Informationen verarbeitet – nicht **was** er denkt oder fühlt. Du beobachtest:

- Welche Verarbeitungskanäle werden genutzt (visuell, auditiv, kinästhetisch)?
- Wie flexibel wechselt das System zwischen Kanälen?
...
- Marker: "Was wäre wenn...", "Ich stelle mir vor...", Zukunftsbezug

---

### 1.4 Nomenklatur für die Dokumentation
...
⚠️ **WICHTIG:** Du analysierst C-Level-Führungskräfte & Unternehmer (35-55 Jahre).
...
### 2.3 Beschädigte Informationskette

Eine beschädigte Kette zeigt strukturelle Störungen:
...
### 2.4 Diagnostische Auswertung der Kette
...
```
WENN ideale Kette K enthält UND beschädigte Kette K fehlt:
→ Hypothese: Stresskompensation durch Entkörperung
→ Unter Druck: Verlust von Resonanz, Frühwarnsignalen
→ Potenzial: K-Integration möglich, da grundsätzlich verfügbar

WENN beschädigte Kette ID dominant:
→ Hypothese: Kognitive Übersteuerung als Sicherheitsstrategie
→ Unter Druck: Schleifen, Rechtfertigung, Entscheidungsverzögerung
→ Potenzial: Klare Selbstführung, wenn ID begrenzt wird

WENN beschädigte Kette V überdominant (V-V-V oder V-A-V-A-V):
→ Hypothese: Kontrolle durch Szenarien/Modellierung
→ Unter Druck: Overthinking, Zukunftsangst, Präsenzverlust
→ Potenzial: Strategische Stärke, wenn mit K gekoppelt
```

---

## TEIL 3: DER INNERE DIALOG (ID)

### 3.1 Definition

Der innere Dialog ist ein **Zustand**, in dem innere Sprache die Verarbeitung dominiert. Er ist mehr als "auditiv" – er ist ein Regulationsmodus.
...
- Verhindert Handlung
- Marker: Wiederholungen, "Ja, aber...", Erklärschleifen, Absolutheit
...
- Absolute Aussagen ohne Nuance
- Selbstbewertung ("Ich bin zu...", "Ich hätte...")
...
**Diagnostische Frage:** Kann die Person sich von der inneren Stimme distanzieren ("Da ist diese Stimme, die sagt...") oder ist sie mit ihr verschmolzen (erlebt es als Wahrheit)?

---

## TEIL 4: DER KINÄSTHETISCHE KANAL (K)
...
- Führt zu Klarheit oder Veränderung
...
- Nicht dosierbar
- Führt zu Erstarrung oder Erschöpfung
...
- Benennung ohne Spüren

**Marker im Transkript:** "Ich denke, ich fühle..." (statt "Ich fühle..."), sofortige Erklärung, keine Körperbezüge
...
## TEIL 5: BEWERTUNG, AVERSION, APPETENZ

### 5.1 Definitionen

**Bewertung:** Der Prozess, der Bedeutung zuweist ("wichtig/unwichtig", "sicher/gefährlich", "gut/schlecht für mich")

**Aversion:** Tendenz WEG VON etwas – Vermeidung, Schutz, Rückzug, aber auch Angriff als Schutz

**Appetenz:** Tendenz HIN ZU etwas – Annäherung, Interesse, Motivation

### 5.2 Aversion erkennen
...
- Marker: Viele Projekte, wenig Abschluss, "Ich muss noch..."

**Diagnostische Frage:** Ist die Appetenz ein "Hin-zu" oder ein verkleidetes "Weg-von"?
...
## TEIL 6: DAS ZEITMODELL

### 6.1 Grundkonzept

Menschen organisieren Zeit unterschiedlich. Das Zeitmodell beschreibt, wie Vergangenheit, Gegenwart und Zukunft innerlich repräsentiert werden.
...
## TEIL 7: KÖRPERLICHE ZEICHEN

### 7.1 Relevanz

Körperliche Zeichen sind die somatische Übersetzung innerer Prozesse. Sie zeigen, in welchem Regulationsmodus das System arbeitet.
...
## TEIL 8: BINDUNGS- UND ABWEHRMUSTER

### 8.1 Bindungsangebote
...
## TEIL 9: ANWENDUNG AUF TRANSKRIPTE
...
**Gesamt:** ~2-2.5 Stunden für qualitativ hochwertige Strukturanalyse
...
Verwende folgende Struktur für die Strukturanalyse:
...
#### BEISPIEL-TRANSKRIPT (Auszug, 400 Wörter):

**Kontext:** C-Level Executive, 45 Jahre, Geschäftsführer, 80 Mitarbeiter
...
**Interviewer:** "Was spüren Sie körperlich, wenn Sie so eine Entscheidung treffen müssen?"

**Klient:** "Körperlich? Hm. [10 Sek Pause] Ich denke, da ist eine gewisse Anspannung. Nacken vielleicht. Aber das ist normal. Das gehört dazu. Man kann nicht weich sein als Geschäftsführer."
...
Tatsächliche Kette: V-VK-VK-A-ID-ID-A-ID-V-A
                    ↑ Szenario-Schleife   ↑ Rechtfertigung

Beschädigung: K fehlt systematisch
```
...
- **Beziehungsdynamik:** Leistung als Bindungsangebot → Team spürt Druck → Fluktuation wahrscheinlich
```

---

## TEIL 10: BUSINESS-ÜBERSETZUNG

### 10.1 Von Struktur zu KPI
...
### 10.3 Fachsprache → Business-Sprache (für Dossier)

⚠️ **KRITISCH:** Diese Tabelle ist für die Dossier-Erstellung!
...
**STRUKTURANALYSE sagt:**
"K-Zugang unter Entscheidungsdruck systematisch abgeschnitten. Beschädigte Kette: V-ID-V-ID ohne K-Integration. Sympathische Dominanz ohne parasympathische Gegenregulation."

**DOSSIER sagt:**
"Unter Entscheidungsdruck verlieren Sie den Zugang zu Körpersignalen. Statt innere Stimmigkeit zu prüfen, bleiben Sie im Gedankenkarussell zwischen Szenarien und Bewertungen. Ihr Nervensystem befindet sich im dauerhaften Stressmodus ohne Möglichkeit zur Beruhigung."

---

## TEIL 11: QUALITÄTSKRITERIEN
...
- ✅ Benennt Blockaden UND Potenziale
- ✅ Ist hypothesenbildend, nicht etikettierend
- ✅ Hat Business-Relevanz

---

### 11.2 Fehler vermeiden

- ❌ Einzelne Aussagen überinterpretieren
- ❌ Blickrichtung = Wahrheit setzen (ist Heuristik!)
- ❌ Inhalte statt Struktur analysieren
- ❌ Diagnosen/Etiketten vergeben
- ❌ Nur Defizite benennen, keine Potenziale
- ❌ Kognitive Aussagen für K halten
...
### 11.4 Overinterpretation-Warnung

⚠️ **KRITISCHE WARNUNG:** Dies ist die größte Gefahr bei AI-gestützter Strukturanalyse!

#### NIEMALS diagnostizieren auf Basis von:

- **1-2 Sätzen** → "Introjekt identifiziert"
- **Einmaligem Muster** → "ID dominant"
- **Fehlenden Körperbezügen in einer Antwort** → "K systematisch abgeschnitten"
- **Einer Metapher** → "V-dominant"
- **Einer Pause** → "Dissoziation"

#### IMMER:

- **Mindestens 3-5 Beispiele** für jedes Muster sammeln
- **"Hypothese:"** oder **"spricht für..."** verwenden
- **Alternative Interpretationen** erwägen
- **Bei Unsicherheit:** Vorbehalt formulieren ("begrenzte Datenbasis", "vorläufige Hypothese")

#### BEISPIELE:

**❌ FALSCH (Overinterpretation):**
"Der Klient sagt einmal 'Ich muss das schaffen' → Introjekt identifiziert: 'Ich muss funktionieren'"

**✅ RICHTIG (angemessene Interpretation):**
"Der Klient verwendet wiederholt (5× im Transkript) Formulierungen wie 'Ich muss...', 'Man sollte...', 'Das gehört sich nicht' → Hypothese: Introjekte um Leistung und soziale Erwartungen"

---

**❌ FALSCH:**
"Der Klient erwähnt keine Körperempfindungen → K systematisch abgeschnitten"

**✅ RICHTIG:**
"Der Klient benennt auf drei direkte Fragen nach Körperempfindungen keine somatischen Bezüge und wechselt schnell zu kognitiven Erklärungen → spricht für reduzierten K-Zugang unter den gegebenen Gesprächsbedingungen"

---

**❌ FALSCH:**
"Der Klient sagt 'Was wenn es schief geht?' → ID dominant, Zukunftsangst, Sequenz-Typ"

**✅ RICHTIG:**
"Der Klient verwendet mehrfach (8× im Transkript) 'Was wenn...'-Formulierungen mit Zukunftsbezug, kehrt nach Beantwortung zu gleichen Szenarien zurück ohne Abschluss → Hypothese: ID-Schleifen mit Zukunftsfokus, spricht für Sequenz-Typ unter Stress"

---

#### QUALITÄTSSICHERUNG:

Bevor du eine Strukturanalyse finalisierst, prüfe:

1. **Datenquantität:** Habe ich für jedes Muster mindestens 3 Beispiele?
2. **Sprachliche Präzision:** Verwende ich Hypothesensprache?
3. **Alternative Erklärungen:** Habe ich andere Interpretationen erwogen?
4. **Kontext:** Berücksichtige ich die Gesprächssituation?
5. **Vorbehalte:** Dokumentiere ich Unsicherheiten?

---

## TEIL 12: INTEGRATION MIT DEEP CLARITY

### 12.1 Bezug zum 5-Phasen-Modell
...
### 12.2 Zielgruppen-Spezifik

Die Deep Clarity Zielgruppe (C-Level, Unternehmer, 35-55 Jahre) zeigt typischerweise:

- **Hohe kognitive Kompetenz** → ID oft elaboriert, VK stark
- **K-Reduktion** → Körperzugang durch Leistungsfokus eingeschränkt
- **Impostor-Muster** → Diskrepanz zwischen äußerem Erfolg und innerer Bewertung
- **Kontrolle als Sicherheit** → Beschädigte Kette zeigt Kontrollüberhang
- **Introjekte um Leistung** → "Ich bin nur wertvoll, wenn ich funktioniere"

---

## ANHANG: CHECKLISTEN

### A. Schnell-Check Verarbeitungskanäle

- [ ] V vorhanden? (Bilder, Szenen, räumlich)
- [ ] A vorhanden? (Sprache, Dialoge, Töne)
- [ ] K vorhanden? (Körper, Gefühle, Empfindungen)
- [ ] ID dominant? (Grübeln, Bewerten, Schleifen)
- [ ] Welcher Kanal fehlt systematisch?

### B. Schnell-Check Informationskette

- [ ] Kanalverfügbarkeit gegeben?
- [ ] Differenzierung erhalten?
- [ ] Bewegung erkennbar?
- [ ] Abschluss möglich?
- [ ] Schleifen identifiziert?

### C. Schnell-Check K-Zugang

- [ ] K wird benannt?
- [ ] K wird lokalisiert (Körperstelle)?
- [ ] K verändert sich?
- [ ] Person bleibt erreichbar dabei?
- [ ] Führt zu Klarheit/Bewegung?

### D. Schnell-Check Abwehr

- [ ] Banalisierung? ("Nicht so wichtig")
- [ ] Rationalisierung? (Erklären statt Fühlen)
- [ ] Kontrolle? (Absicherung, Detailfokus)
- [ ] Projektion? (Andere sind schuld)
- [ ] Vermeidung? (Themenwechsel)

### E. Schnell-Check Business-Relevanz

- [ ] Entscheidungsverhalten ableitbar?
- [ ] Führungsverhalten ableitbar?
- [ ] Stressmuster erkennbar?
- [ ] Beziehungsdynamik erkennbar?
- [ ] Potenziale für Veränderung identifiziert?

### F. Schnell-Check Overinterpretation (NEU)

- [ ] Mindestens 3-5 Beispiele für jedes Muster?
- [ ] Hypothesensprache verwendet? ("spricht für...", "deutet auf...")
- [ ] Alternative Erklärungen erwogen?
...
Dieses Dokument befähigt dich zur Durchführung von Strukturanalysen nach der Deep Clarity Methode. Wende es an, wenn du Transkripte, Notizen oder diagnostische Beobachtungen erhältst und eine Strukturanalyse erstellen sollst.

**WICHTIG:** Diese Strukturanalyse ist INPUT für das Dossier-Erstellung-Skill. Die Business-Übersetzung (Teil 10.3) ist essentiell für die Dossier-Qualität!
