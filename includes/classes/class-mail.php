...
class Mail
{
     ...
     */
    private function register_fluentform_hooks()
    {
    ...
    /**
     * Wrap Fluent Forms email content in Deep Clarity template
     *
     ...
     * @return string Modified email body with Deep Clarity template.
     */
    public function wrap_fluentform_email($emailBody, $notification, $submittedData, $form)
    {
        // Get the subject from notification or use default
        $subject = isset($notification->subject) ? $notification->subject : 'Benachrichtigung';

        // Use the Deep Clarity email template wrapper
        return $this->get_email_template_wrapper($subject, $emailBody);
    }

    /**
     * Get email template wrapper for external content (e.g., Fluent Forms)
     *
     * @param string $subject Email subject.
     * @param string $content Email content (HTML).
     * @return string Complete HTML email template.
     */
    public function get_email_template_wrapper($subject, $content)
    {
        $template = '<!--
...
<table class="t38" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;"><tr><td class="t37" style="padding:32px 32px 32px 32px;"><p class="t36" style="margin:0;Margin:0;font-family:Inter,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:22px;font-weight:500;font-style:normal;font-size:11px;text-decoration:none;text-transform:none;direction:ltr;color:#7E6D54;text-align:left;mso-line-height-rule:exactly;mso-text-raise:3px;">&copy; Deep Clarity. Alle Rechte vorbehalten.<br/><br/><a href="https://deepclarity.de/impressum/" style="color:#7E6D54;text-decoration:underline;">Impressum</a><br/><a href="https://deepclarity.de/datenschutz/" style="color:#7E6D54;text-decoration:underline;">Datenschutz</a><br/><a href="https://deepclarity.de/agb/" style="color:#7E6D54;text-decoration:underline;">AGB</a></p></td></tr></table>
</td></tr></table>
</td></tr></table></td></tr></table>
</td>
<td></td></tr>
